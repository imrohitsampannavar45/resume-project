...
const Dashboard = () => {
  const colors = [
    "#9333ea", "#dc2626", "#fbbf24", "#818cf8", "#34d399",
    "#f87171", "#fbbf24", "#dc2626", "#0284c7", "#16a34a"
  ]
              ...
              <button
                ...
                <div
                  ...
                  <PencilIcon
                    ...
                    className='size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors ml-2' />
                </div>
              </button>
            )
          })}
            ...
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <div>
                <label htmlFor="resume-input" className='block text-sm text-slate-700'>
                  Select resume file
                  <div className='flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-5 hover:border-green-500 hover:text-green-700 cursor-pointer transition-colors'>
                    {resume ? (
