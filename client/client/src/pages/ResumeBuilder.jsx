...
import PersonalInoForm from '../components/PersonalInoForm'
      ...
      <div className='max-w-7xl mx-auto px-4 pb-8'>
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1 relative'>
              ...
              <div className='space-y-6'>
                ...
                {/* You can add other section forms here like summary, experience, etc. */}
              </div>
            </div>
          </div>

          {/* Right Section (Preview or Output) */}
          <div className='lg:col-span-7 max-lg:mt-6'>
            ...
            {/* Add your preview or resume template here */}
